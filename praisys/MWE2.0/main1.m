...
for i = 1:NRun * Nsamples
    ...
    % save input data for optimization computation (schedule 2)
...
%% 
% Clean Data
clear ans index i n Comm_Fun data_index Days m name End_Day finish filename Pow_Fun Start_Day Trans_Fun Total Total_Schedule Transportation_Set Power_Set Communication_Set;