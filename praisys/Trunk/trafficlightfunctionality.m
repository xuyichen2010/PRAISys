...
% Compute functionality of a traffic light


function [Q , restoration_completion, state0] = trafficlightfunctionality(IMtype,IM,Cclass,timesteps,sample,restoration_completion_unif)
